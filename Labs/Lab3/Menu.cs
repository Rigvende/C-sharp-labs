...
namespace Labs3
{
    class Menu
    {
        ...
        public static void MakeChoice(ref ArrayList list)
        {
            int choice = ShowMenu();
            switch (choice)
            {
        ...
        public static void ShowList(ArrayList list)
        {
            for (int i = 0; i < list.Count; i ++)
            {
                ...
                {
                    Console.WriteLine("Not a toy car");
                }
            }
        }

        public static void AddElement(ref ArrayList list)
        {
        ...
        public static void AddElementByIndex(ref ArrayList list) {
            Console.Write("Do you want to add [1] ToyCar or [2] PoliceCar? Enter number: ");
            switch (Console.ReadLine())
            {
                case "1":
        ...
        static void AddIndex(ref ArrayList list, IMove item)
        {
        ...
        public static void FindElementFromStart(ArrayList list)
        {
        ...
        public static void FindElementFromEnd(ArrayList list)
        {
            Console.WriteLine("Enter the name of object: ");
            string name = Console.ReadLine();
            IMove item = new ToyCar
        ...
        public static void DeleteElementByIndex(ref ArrayList list) {
            Console.Write("Enter index from 0 to {0}: ", list.Count - 1);
            int choice;
            try
            {
        ...
        public static void DeleteElementByName(ref ArrayList list) {
            Console.WriteLine("Enter the name of object: ");
            string name = Console.ReadLine();
            IMove item = new ToyCar
            {
        ...
        public static void ReverseList(ref ArrayList list) {
            list.Reverse();
            Console.WriteLine("List is reversed");
        }

        public static void SortList(ref ArrayList list) {
            list.Sort();
            Console.WriteLine("List is sorted.");
        }

        public static void CallMethod(ArrayList list) {
